...
-- Last modification date: 2024-12-08 22:35:37.354
...
CREATE TABLE Currency (
    Currency_ID varchar(3)  NOT NULL IDENTITY(1, 1),
...
CREATE TABLE OrdersDetails (
    ...
    CONSTRAINT ORDC CHECK (LEN(Currency_ID) = 3 AND LEN(Status) >1 AND Cost>=0 AND YEAR(ConfirmDate) >= 2024),
